  ...
  async loadSkills() {
    try {
      ...
      document.getElementById("skillCount").textContent = `${
        userSkills.length
      } conhecimento${userSkills.length !== 1 ? "s" : ""}`;
        ...
        (project) => `
            <div class="project-card">
                <div class="project-header">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="#" onclick="editProject('${
                              project.id
                            }')">
                ...
                <div class="mb-2">
                    ${project.keywords
                      .map(
                        (keyword) => `<span class="tag">${keyword.name}</span>`
                      )
                      .join("")}
                </div>
                <div class="mt-3">
                    <small class="text-gray">
                        ...
                        <a href="${
                          project.link
                        }" target="_blank" rel="noopener noreferrer" class="text-gray">
            ...
            <div class="skill-card">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="#" onclick="editSkill('${
                              skill.id
                            }')">
                                <i class="bi bi-pencil me-2"></i>Editar
                            </a></li>
                            <li><a class="dropdown-item text-danger" href="#" onclick="deleteSkill('${
                              skill.id
                            }')">
                                <i class="bi bi-trash me-2"></i>Excluir
                            </a></li>
  ...
  initializeEventListeners() {
    ...
    skillLevel?.addEventListener("input", (e) => {
      ...
      const labels = document.querySelectorAll(
        "#addSkillForm .form-range + div small"
      );
  ...
  async addProject() {
    try {
      const formData = {
        ...
        keywords: Array.from(
          document.getElementById("projectKeywords").selectedOptions
        ).map((opt) => opt.value),
      };
